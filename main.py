...
Peter, the crew, and the fund. When running the program it will ask you to enter in a number
of reavers in the crew and the number of units they have. Make sure you enter in postive
integers for the input, three or more crew members and enough units.
